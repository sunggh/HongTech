 ...
 *
 * <p>To render the mesh, use {@link RenderingHelper#draw()}.
 */
public class Mesh implements Closeable {
   ...
   * (location 2, vec3).
   */
  public static Mesh createFromAsset(RenderingHelper render, String assetFileName) throws IOException {
   ...
   * prefer {@link RenderingHelper#draw}.
   */
