...
public class SpecularCubemapFilter implements Closeable {
   ...
   */
  public SpecularCubemapFilter(RenderingHelper render, int resolution, int numberOfImportanceSamples)
      throws IOException {
  ...
  private Shader[] createShaders(RenderingHelper render, ChunkIterable chunks) throws IOException {
