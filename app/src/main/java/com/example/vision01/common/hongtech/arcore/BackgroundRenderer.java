 ...
 */
package com.example.vision01.common.hongtech.arcore;
...
public class BackgroundRenderer {
   ...
   * during a {@link RenderingHelper.Renderer} callback, typically in {@link
   * RenderingHelper.Renderer#onSurfaceCreated()}.
   */
  public BackgroundRenderer(RenderingHelper render) {
    cameraColorTexture =
        new Texture(
            render,
   ...
   */
  public void setUseDepthVisualization(RenderingHelper render, boolean useDepthVisualization)
      throws IOException {
   ...
   */
  public void setUseOcclusion(RenderingHelper render, boolean useOcclusion) throws IOException {
   ...
   */
  public void drawBackground(RenderingHelper render) {
  ...
  public void drawVirtualScene(
          RenderingHelper render, Framebuffer virtualSceneFramebuffer, float zNear, float zFar) {
