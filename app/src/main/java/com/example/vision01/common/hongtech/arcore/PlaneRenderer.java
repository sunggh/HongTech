...
import com.example.vision01.common.hongtech.IndexBuffer;
...
import com.example.vision01.common.hongtech.Shader.BlendFactor;
...
public class PlaneRenderer {
   ...
   * a {@link RenderingHelper.Renderer} callback, typically in {@link
   * RenderingHelper.Renderer#onSurfaceCreated}.
   */
  public PlaneRenderer(RenderingHelper render) throws IOException {
    Texture texture =
  ...
  public void drawPlanes(
          RenderingHelper render, Collection<Plane> allPlanes, Pose cameraPose, float[] cameraProjection) {
