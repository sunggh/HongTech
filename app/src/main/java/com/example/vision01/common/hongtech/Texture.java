...
public class Texture implements Closeable {
   ...
   */
  public Texture(RenderingHelper render, Target target, WrapMode wrapMode) {
    this(render, target, wrapMode, /*useMipmaps=*/ true);
  }

  public Texture(RenderingHelper render, Target target, WrapMode wrapMode, boolean useMipmaps) {
    this.target = target;
  ...
  public static Texture createFromAsset(
          RenderingHelper render, String assetFileName, WrapMode wrapMode, ColorFormat colorFormat)
      throws IOException {
