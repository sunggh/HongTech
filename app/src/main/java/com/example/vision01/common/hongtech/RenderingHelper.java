 ...
 */
package com.example.vision01.common.hongtech;
...
public class RenderingHelper {
  private static final String TAG = RenderingHelper.class.getSimpleName();
   ...
   */
  public RenderingHelper(GLSurfaceView glSurfaceView, Renderer renderer, AssetManager assetManager) {
    ...
    glSurfaceView.setRenderer(
        new GLSurfaceView.Renderer() {
          ...
          public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            renderer.onSurfaceCreated(RenderingHelper.this);
          }
          ...
          public void onSurfaceChanged(GL10 gl, int w, int h) {
            viewportWidth = w;
            viewportHeight = h;
            renderer.onSurfaceChanged(RenderingHelper.this, w, h);
          }

          @Override
          public void onDrawFrame(GL10 gl) {
            clear(/*framebuffer=*/ null, 0f, 0f, 0f, 1f);
            renderer.onDrawFrame(RenderingHelper.this);
          }
        });
  ...
  public static interface Renderer {
    /**
     * Called by {@link RenderingHelper} when the GL render surface is created.
     *
    ...
    /**
     * Called by {@link RenderingHelper} when the GL render surface dimensions are changed.
     *
    ...
    /**
     * Called by {@link RenderingHelper} when a GL frame is to be rendered.
     *
